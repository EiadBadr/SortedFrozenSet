...
class TestConstruction(unittest.TestCase):
    ...
    def test_construct_from_iterator(self):
        l = [1,2,3,4]
        itertor = iter(l)
        s = SortedFrozenSet(itertor)
        
    def test_construct_no_arg(self):
        s = SortedFrozenSet()
...
class TestContainerProtocol(unittest.TestCase):
    ...
    def test_postive_contained(self):
        self.assertTrue(9 in self.s)

    def test_negative_contained(self):
        self.assertFalse(False)

    def test_postive_not_contained(self):
...
class TestSizedProtocol(unittest.TestCase):
    ...
    def test_duplicate(self):
        s = SortedFrozenSet([100, 100, 100])
        self.assertEqual(len(s), 1)

    def test_protocol(self):
        self.assertTrue(issubclass(SortedFrozenSet, Sized))

class TestItrableProtocol(unittest.TestCase):
...
class TestSequenceProtocol(unittest.TestCase):
    ...
    def test_index_positive(self):
        s = SortedFrozenSet([1,3,5,7,9])
        self.assertEqual(s.index(7) , 3)
    ...
    def test_repetition_negative_self(self):
        s = SortedFrozenSet([1, 2, 3])
...
class TestReprProtocol(unittest.TestCase):
    ...
    def test_repr_one(self):
        s = SortedFrozenSet([1, 5, 3])
        self.assertEqual(repr(s), "SortedFrozenSet([1, 3, 5])")

class TestEqualityProtocol(unittest.TestCase):
        
    def test_postive_equal(self):
        self.assertTrue(
            SortedFrozenSet([1, 5, 3]) == SortedFrozenSet([1, 3, 5])
            )

    def test_negative_equal(self):
        self.assertFalse(
            SortedFrozenSet([1, 9, 0]) == SortedFrozenSet([1, 3, 5])
            )

    def test_type_mismatch(self):
        self.assertFalse(
            SortedFrozenSet([1, 3, 5]) == [1, 3, 5]
            )
        
    def test_type_identical(self):
        s = SortedFrozenSet([1, 3, 5])
        self.assertTrue(s==s)
...
class TestHashableProtocol(unittest.TestCase):
    ...
    def test_equal_sets_have_the_same_hash_code(self):
        self.assertEqual(
            hash(SortedFrozenSet([1, 3, 5])),
            hash(SortedFrozenSet([1, 3, 5]))
        )

class TestRelationalSetProtocol(unittest.TestCase):
    
    def test_lt_postive(self):
    ...
    def test_le_lt_postive(self):
        s = SortedFrozenSet({1, 2})
        t = SortedFrozenSet({1, 2, 3})
        self.assertTrue(s <= t)

    def test_le_eq_postive(self):
        s = SortedFrozenSet({1, 2, 3})
        t = SortedFrozenSet({1, 2, 3})
        self.assertTrue(s <= t)
    ...
    def test_ge_gt_postive(self):
        s = SortedFrozenSet({1, 2, 3})
        t = SortedFrozenSet({1, 2})
        self.assertTrue(s > t)

    def test_ge_eq_postive(self):
        s = SortedFrozenSet({1, 2, 3})
        t = SortedFrozenSet({1, 2, 3})
        self.assertTrue(s >= t)
...
class TestSetRelationalMethods(unittest.TestCase):
    ...
    def test_issubset_postive(self):
        s = SortedFrozenSet({1, 2, 3})
        t = [1, 2, 3]
    ...
    def test_issuperset_proper_postive(self):
        s = SortedFrozenSet({1, 2, 3})
        t = [1, 2]
        self.assertTrue(s.issuperset(t))
    
    def test_issuperset_postive(self):
        s = SortedFrozenSet({1, 2, 3})
        t = [1, 2, 3]
        self.assertTrue(s.issuperset(t))
    ...
    def test_isdisjoint_postive(self):
        s = SortedFrozenSet({1, 2, 3})
        t = [4, 5, 6]
